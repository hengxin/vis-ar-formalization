...
\setboolean{shading}{true}
 ...
 {\MODULE} TCM}\moduleRightDash\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} Sequences}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
TLA+ specification of classic transactional consistency models
 (hence the name \ensuremath{TCM}), following the framework proposed by
 Andrea \ensuremath{Cerone}, \ensuremath{Giovanni} \ensuremath{Bernardi}, and
 \ensuremath{Alexey} \ensuremath{Gotsman} in their
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{T}{F}{0}{10.0}{}%
\ensuremath{\.{-} CONCUR\.{'}}2015 paper:
 A Framework for \ensuremath{Transactional} Consistency Models with Atomic
 Visibility\ensuremath{.
}%
\end{cpar}%
\begin{cpar}{1}{T}{F}{0}{10.0}{}%
\ensuremath{\.{-} JACM\.{'}}2018 paper:
 Analysing Snapshot Isolation
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\CONSTANTS} Key ,\, Val ,\,
 EventId}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} Op \.{\defeq} [ type \.{:}
 \{\@w{read} ,\,\@w{write} \} ,\, key \.{:} Key ,\, val \.{:} Val ]}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} R ( k ,\, v )\@s{4.14}
 \.{\defeq} [ type \.{\mapsto}\@w{read} ,\, key \.{\mapsto} k ,\, val
 \.{\mapsto} v ]}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} W ( k ,\, v ) \.{\defeq} [
 type \.{\mapsto}\@w{write} ,\, key \.{\mapsto} k ,\, val \.{\mapsto} v ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} Event \.{\defeq} [ eid \.{:}
 EventId ,\, op \.{:} Op ]}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} REvent ( k )\@s{2.69}
 \.{\defeq} \{ e \.{\in} Event \.{:} e . op . type \.{=}\@w{read} \.{\land} e
 . op . key \.{=} k \}}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} WEvent ( k ) \.{\defeq} \{ e
 \.{\in} Event \.{:} e . op . type \.{=}\@w{write} \.{\land} e . op . key
 \.{=} k \}}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} HEvent ( k )\@s{2.55}
 \.{\defeq} REvent ( k ) \.{\cup} WEvent ( k )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} Transaction \.{\defeq} Seq (
 Event )\@s{8.2}}%
\@y{\@s{0}%
 A transaction is a sequence of events.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} Session\@s{0.01} \.{\defeq}
 Seq ( Transaction )\@s{1.09}}%
\@y{\@s{0}%
 A session is a sequence of transactions.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} History \.{\defeq} {\SUBSET}
 Session\@s{7.26}}%
\@y{\@s{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 26 21:35:03 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Apr} 26
 20:51:33 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
